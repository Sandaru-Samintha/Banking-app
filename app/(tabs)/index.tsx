...
import { client, DATABASE_ID, databases, HABITS_COLLECTION_ID, RealtimeResponce } from "@/lib/appwrite";
...
export default function Index() {
  ...
  const [habits,setHabits]=useState<Habit[]>()  //ceate the habits in types folder reee usigs because any type of habits use in this

  useEffect(()=>{
    fetchHabits();

    const habitsSubscription =client.subscribe(`databases.${DATABASE_ID}.collections.${HABITS_COLLECTION_ID}.documents`,
      (response:RealtimeResponce)=>{
